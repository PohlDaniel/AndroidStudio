...
ColladaLoader::ColladaLoader(const std::string & path, AAssetManager* assetManager) {
...
void ColladaLoader::createIndexBuffer(std::vector<Vector3f> &positions, std::vector<Vector2f> &texCoords, std::vector<Vector3f> &normals, std::vector<std::array<unsigned int, 4>> &jointIds, std::vector<Vector4f> &jointWeights, std::vector<unsigned int> &indices, std::vector<VertexSkinData> &skinningData) {
	...
	for (int i = 0; i < numberOfTriangles; i++) {
		...
		float vertex1[] = { positions[indices[i * vertexstride + offsetPositions + offset * 0]][0]    , positions[indices[i * vertexstride + offsetPositions + offset * 0]][1]    , positions[indices[i * vertexstride + offsetPositions + offset * 0]][2],
			...
			(float)skinningData[indices[i * vertexstride + offsetPositions + offset * 0]].jointIds[0], (float)skinningData[indices[i * vertexstride + offsetPositions + offset * 0]].jointIds[1], (float)skinningData[indices[i * vertexstride + offsetPositions + offset * 0]].jointIds[2],
		...
		float vertex2[] = { positions[indices[i * vertexstride + offsetPositions + offset * 1]][0], positions[indices[i * vertexstride + offsetPositions + offset * 1]][1], positions[indices[i * vertexstride + offsetPositions + offset * 1]][2],
			...
			(float)skinningData[indices[i * vertexstride + offsetPositions + offset * 1]].jointIds[0], (float)skinningData[indices[i * vertexstride + offsetPositions + offset * 1]].jointIds[1], (float)skinningData[indices[i * vertexstride + offsetPositions + offset * 1]].jointIds[2],
		...
		float vertex3[] = { positions[indices[i * vertexstride + offsetPositions + offset * 2]][0], positions[indices[i * vertexstride + offsetPositions + offset * 2]][1], positions[indices[i * vertexstride + offsetPositions + offset * 2]][2],
			...
			static_cast<float>(skinningData[indices[i * vertexstride + offsetPositions + offset * 2]].jointIds[0]), static_cast<float>(skinningData[indices[i * vertexstride + offsetPositions + offset * 2]].jointIds[1]), static_cast<float>(skinningData[indices[i * vertexstride + offsetPositions + offset * 2]].jointIds[2]),
	...
	for (int i = 0; i < m_vertexBuffer.size(); i = i + 14) {
		...
		std::array<unsigned int, 4> jointId = { static_cast<unsigned int>(m_vertexBuffer[i + 8]), static_cast<unsigned int>(m_vertexBuffer[i + 9]), static_cast<unsigned int>(m_vertexBuffer[i + 10]), 0 };
